...
Dispatches to the specific training scripts in src/scripts/classification/ with
consistent defaults. Use this as a single entry point for a full method sweep
rather than invoking individual scripts manually.

Usage:
    python3 src/scripts/utils/benchmark_all_methods.py --methods kmer fm --k-values 4 5 6
    python3 src/scripts/utils/benchmark_all_methods.py \\
        --methods kmer --model InstaDeepAI/NTv3_650M_pre
"""

"""
Ridge Regression multiscale k-mer → FM embeddings per tutti i dataset.

Addestra RidgeCV con:
  X = vettore frequenze k-mer multiscale (concat di 4^k per ogni k)
  Y = embedding FM                       (D features)

Salva R² e MSE globali in records.csv.

Usage:
    python3 src/fm_experiment/train_ridge_multiscale.py --model InstaDeepAI/NTv3_650M_pre --k-values 4 5 6
    python3 src/fm_experiment/train_ridge_multiscale.py --model LongSafari/hyenadna-medium-160k-seqlen-hf --k-values 4 5 6
"""

...
Estrae il vettore dall'embedding layer (lookup table statica) del modello FM,
PRIMA che passi attraverso i transformer/hyena layers.
Questo cattura la rappresentazione "statica" dei token, senza contesto.

Output: (N, embed_dim) float16 mean-pooled over non-padding tokens.
Cached su disco come .npz.
"""
...
class TokenizerEmbedder:
    ...
    def __init__(
        ...
        # Carica il modello completo, poi estrai solo l'embedding layer
